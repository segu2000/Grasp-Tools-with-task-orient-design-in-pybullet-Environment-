...
class sawyer:
	...
	def reset(self):
		self.sawyerId = p.loadURDF("./data/sawyer_robot/sawyer_description/urdf/sawyer.urdf",[0,0,-0.5], [0,0,0,3], useFixedBase = 1)
		...
		self.trayUid = p.loadURDF("./data/table/table.urdf", [1.1, 0.000000, -0.3], p.getQuaternionFromEuler([(math.pi/2), 0, (math.pi/2)]), useFixedBase = 1, flags = 8)
